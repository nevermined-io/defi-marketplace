...
import { UiText, UiDivider, UiLayout } from 'ui'
  ...
  return (
    <>
      <UiLayout type="container">
        <UiText wrapper="h1" type="h1" variants={['heading']}>About</UiText>
        <UiLayout>
          <UiText type="h2" wrapper="h2">Info on the keyko defi marketplace</UiText>
        </UiLayout>
        <UiDivider/>
