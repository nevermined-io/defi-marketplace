  ...
  return (
    <>
      ...
      <UiLayout type="container">
        ...
        >
          The Nevermined DeFi Marketplace
          <br />
          features datsets from your favorite networks, these include:
        </UiText>
        ...
        <UiText
          ...
          variants={['secondary', 'detail']}
        >
          All the ways you can discover and navigate data
          <br />
          on the Nevermined DeFi data marketplace
        </UiText>
          ...
          <UiLayout type="sides">
            ...
            <UiLayout type="grid" align="center" direction="column">
              ...
              <UiText
                ...
                variants={['secondary', 'detail']}
              >
                We ensure that the data sets availiable on our platform are normalized for
                analtyical purposes, enabling usability regardless of proficiency in blockchain or
                DeFi.
              </UiText>
            </UiLayout>
          </UiLayout>
          ...
          <UiLayout type="sides">
            <UiLayout type="grid" align="center" direction="column">
              <Image
                ...
                height="126"
                className={b('landingImage')}
                src="/assets/filtering.svg"
              />
              <UiText className={b('bannerText')} variants={['secondary']} wrapper="h3" type="h3">
                Precision Filtering & Search
              </UiText>
              <UiDivider />
              <UiText
                className={b('featureSectionText')}
                ...
                variants={['secondary', 'detail']}
              >
                Our practical search engine and filtering capabilities allow you to intuitively find
                the data sets you’re looking and save them to your basket until you’re ready to
                check out.
              </UiText>
            </UiLayout>
            <UiLayout type="grid" align="center" direction="column">
        ...
        <div className={b('key-insights-text')}>
          <UiLayout type="container" style={{ padding: '0' }}>
            ...
            <UiText
              ...
              className={b('defaultMargin')}
              type="p"
              variants={['detail']}
            >
              Gain the advantage in your Defi analysis and investment models by obtaining data sets
              aggregated daily from leading protocols such as Ethereum and IPFS.* From DeFi lending
              and historical DEX events, we make normalized datasets avalaible for download, so that
              you don’t have to run conversions when performing data analysis.
              <br />
              <br />
            ...
            <div style={{ display: 'flex', margin: '5px 0 20px' }}>
              <ul className={b('categories-list')} style={{ listStyleType: 'square' }}>
                ...
                <li onClick={() => Router.push('/list?selectedCategories=Flashloans')}>
                  Flashloans
                </li>
                <li onClick={() => Router.push('/list?selectedCategories=Liquidations')}>
                  Liquidations
                </li>
              </ul>
              <ul className={b('categories-list')} style={{ listStyleType: 'square' }}>
        ...
        <div className={b('get-involved-text')}>
          <UiLayout type="container" style={{ padding: '0' }}>
            ...
            <UiText className={b('defaultMargin')} type="p" variants={['detail']}>
              The Nevermined DeFi data marketplace aims to bridge the gap between Decentralized
              Finance (DeFi) and data analytics.
              <br />
              <br />
              Our vision is to foster a collaborative ecosystem that helps data analysts to search
              for, purchase and propose DeFi, blockchain and Web 3 protocol related data sets.
            </UiText>
            <UiLayout type="container">
              ...
              >
                ...
                <div>
                  <img
                    ...
                    height="91"
                    className={b('landingImage')}
                    src="/assets/logos/nevermined_text.png"
                  />
                </div>
              </div>
            </div>
