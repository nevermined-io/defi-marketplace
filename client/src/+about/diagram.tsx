  ...
  <Fragment>
    ...
    <div className={b('row')}>
      <div className={b('networks')}>
        <img
          ...
          height="200"
          className={b('circle')}
          src="/assets/diagram/radial-gradient-circle.svg"
        />
    ...
    <div className={b('row')}>
      ...
      <div className={b('retrieval-wrapper')}>
        ...
        <div className={b('retrieval-text')}>
      ...
      <div className={b('logo-and-text', ['python'])}>
        ...
        <div className={b('small-text', ['python'])}>
    ...
    <div className={b('nevermined-wrapper')}>
      ...
      <div className={b('nevermined-text')}>
        Then the link to the file is pulished in NVM and the dataset is available to download in the
        marketplace, doing a payment through NVM
      </div>
    </div>
