  ...
  if (error) {
    return (
      <>
        <div className={b('confirm')} style={{ height: '420px' }}>
          ...
          <UiDivider type="s" />
          <UiButton className={b('button')} type="error" onClick={cleanAndClose}>
            Return
          </UiButton>
        </div>
      </>
      ...
      <>
        <div className={b('confirm')}>
          ...
          <UiLayout style={{ padding: '30px' }}>
            ...
            <UiDivider vertical />
            <UiButton className={b('button')} type="secondary" onClick={cleanAndClose}>
              Cancel
            </UiButton>
          </UiLayout>
        </div>
    ...
    return (
      <>
        <div className={b('options')}>
          <UiText block type="h3" className={b('text', ['title'])}>
            multiple asset package being created....
          </UiText>
          <UiDivider type="s" />
          <CircleSpinner
            width="150"
          ...
          <UiText block type="p" className={b('text')}>
            If the package takes too long to create, you can leave this page. As soon as the
            purchase is ready, we will notify you on your profile page.
          </UiText>
          <UiLayout></UiLayout>
          <UiLayout style={{ padding: '5px', justifyContent: 'center' }}>
            <UiButton className={b('button')} onClick={goToProfile}>
              Go to profile
            </UiButton>
            <UiDivider vertical />
            <UiButton className={b('button')} type="secondary" onClick={cleanAndClose}>
    ...
    return (
      <>
        <div className={b('confirm')}>
          <UiText block type="h3" className={b('text')}>
            Your datasets are ready to download
          </UiText>
          <UiDivider type="s" />
          <Image width="50" height="50" src="/assets/nevermined-color.svg" />
          <UiDivider type="s" />
          <UiLayout style={{ padding: '5px', justifyContent: 'center' }}>
            <UiButton className={b('button')} onClick={startPurchase}>
              Purchase
            </UiButton>
            <UiDivider vertical />
            <UiButton className={b('button')} type="secondary" onClick={cleanAndClose}>
    ...
    return (
      <>
        <div className={b('confirm')} style={{ height: '450px' }}>
          <UiText block type="h3" className={b('text')}>
            This process is taking more than expected
          </UiText>
          <Image width="50" height="50" src="/assets/nevermined-color.svg" />
          <UiText block type="p" className={b('text', ['more-than-expected'])}>
            The process is taking longer than expected, you can now leave this page. As soon as the
            purchase is ready, we will notify you on your profile page.
          </UiText>
          <UiLayout style={{ padding: '5px', justifyContent: 'center' }}>
            <UiButton className={b('button')} onClick={goToProfile}>
