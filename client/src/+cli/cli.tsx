    ...
    if (view == 1) {
      ...
      return (
        <>
          ...
          <Markdown
            code='$ export MNEMONIC="<your 12 words seed phrase>"'
            height="111px"
          ></Markdown>
          <UiText>Or use keyfiles</UiText>
          <Markdown code={'$ export KEYFILE_PATH="<path to keyfile>"'} height="111px"></Markdown>
          <Markdown
            code={'$ export KEYFILE_PASSWORD="<keyfile password>"'}
            height="111px"
          ></Markdown>
          <UiText>Also the RPC provider should be set</UiText>
          <Markdown
            code={'export NODE_URL="https://rinkeby.infura.io/v3/INFURA_TOKEN"'}
            height="111px"
          ></Markdown>
          <UiText>or</UiText>
          <Markdown
            code={'export NODE_URL="https://eth-rinkeby.alchemyapi.io/v2/-ALCHEMY_TOKEN"'}
            height="111px"
          ></Markdown>
        </>
      )
      ...
      return (
        <>
          ...
          <UiText>
            Nevermined protocol is deployed in several networks, in order to select the correct one,
            ...
            code={
              <>
                ...
                <p>
                  ...
                  defiMatic:
                  <br />
                  Gateway: https://gateway.matic.nevermined.rocks
                  <br />
                  Metadata API: https://metadata.matic.nevermined.rocks
                </p>
              </>
            }
            height="310px"
      ...
      return (
        <>
          ...
          <UiText>
            To download an asset first we need to know the asset identifier, to do so, we can searh
            for assets with
          </UiText>
          <Markdown code="$ncli assets search Aave -n defiMatic" height="111px"></Markdown>
          <UiText>
            {'That will return the list of assets that includes the term "Aave" in the asset name'}
          </UiText>
          <Markdown
            code={
              <>
                <p>
                  dataset Name: Aave-v2-Ethereum_20210807_00:00.csv - Url:
                  did:nv:c29c3d18d056579203be988e51603288229dfa84b547a29055b98163cbf622d1
                  <br />
                  dataset Name: Aave-v2-Ethereum_20210808_00:00.csv - Url:
                  did:nv:11d5c64740797b6ceaaea311c8e33fdeefb502301bec56831c2f5808a6a5cfe0
                  <br />
                  dataset Name: Aave-v2-Ethereum_20210804_00:00.csv - Url:
                  did:nv:b28c53b3268853f25ea53f145c2c45b7fed2eb04ebf6fd301274cca1914907fb
                  <br />
                  dataset Name: Aave-v2-Ethereum_20210802_00:00.csv - Url:
                  did:nv:e958a092bb50c65047a28f6f26c7e46d7470c78e96d24b7ee66cf7efaf4d589d
                </p>
              </>
            }
            height="310px"
          ...
          ></Markdown>
          <UiText>
            Now we can download any of the existing assets. The next command will order and download
            the asset files into your system:
          </UiText>
          <Markdown
            code={
              '$ ncli assets get did:nv:e958a092bb50c65047a28f6f26c7e46d7470c78e96d24b7ee66cf7efaf4d589d'
            }
            height="110px"
          ></Markdown>
        </>
